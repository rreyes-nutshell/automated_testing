...
async def run_browser_script(steps, session_id=None, login_url=None, username=None, password=None, preview_mode=False, target_label=None, parent_label=None):
	timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
	debug_log("Entered")
...
=======
					...
					# 🔄 Perform mapped navigation if labels are provided
					if target_label:
...
<<<<<<< HEAD
				# ⛔️ Skip login selectors if already logged in
=======
